...
before packages are loaded."
  (let ((my-config (expand-file-name "~/.spacemacs.d/user-config.el")))
    (if (file-exists-p my-config)
        (load my-config nil 'nomessage)
      (message "Spacemacs: no user config found at %s" my-config)
      )
    )
  )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ac-ispell ace-jump-helm-line ace-link ace-window afternoon-theme
         ...
         birds-of-paradise-plus-theme blacken bmx-mode browse-at-remote
         bubbleberry-theme busybee-theme centered-cursor-mode cfrs
         cherry-blossom-theme chocolate-theme cider cider-eval-sexp-fu
         clean-aindent-mode clojure-mode clojure-snippets closql clues-theme
         code-cells code-review color-theme-sanityinc-solarized
         color-theme-sanityinc-tomorrow column-enforce-mode company-anaconda
         company-lua csv-mode cyberpunk-theme cython-mode dakrone-theme
         darkmine-theme darkokai-theme darktooth-theme deferred define-word
         devdocs diminish dired-quick-sort django-theme doom-themes dotenv-mode
         dracula-theme drag-stuff dumb-jump editorconfig ef-themes elisp-def
         elisp-slime-nav emacsql emmet-mode emojify emr esh-help
         eshell-prompt-extras eshell-z espresso-theme ess-R-data-view evil-anzu
         ...
         flycheck-package flycheck-pos-tip forge fsharp-mode fuzzy gandalf-theme
         ggtags gh-md ghub git-commit git-gutter-fringe git-link git-messenger
         git-modes git-timemachine gitignore-templates gnuplot golden-ratio
         google-translate gotham-theme gptel gptel-agent grandshell-theme
         groovy-imports groovy-mode gruber-darker-theme gruvbox-theme haml-mode
         hc-zenburn-theme helm helm-ag helm-c-yasnippet helm-cider helm-company
         ...
         hl-todo holy-mode htmlize hungry-delete hybrid-mode importmagic
         indent-guide info+ inkpot-theme inspector ir-black-theme ivy jazz-theme
